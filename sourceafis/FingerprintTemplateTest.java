...
public class FingerprintTemplateTest {
	...
	private static byte[] load(String name) {
            //"C:\\tonny\\projecting\\Test1\\src\\test\\resources\\com\\machinezoo\\sourceafis\\" + name
            ///com/machinezoo/sourceafis/
		return Exceptions.sneak().get(() -> {
			try (InputStream input = FingerprintTemplateTest.class.getResourceAsStream("C:\\tonny\\projecting\\Test1\\src\\test\\resources\\com\\machinezoo\\sourceafis\\" + name)) {
